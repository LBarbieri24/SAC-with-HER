...
from SAC_2 import SACAgent,ReplayBufferHER
...
for epoch in range(epochs):
    ...
    save_filename1 = f'/kaggle/working/sac_policy_{epoch}_HER_dense_rewards.pt'
    save_filename2 = f'/kaggle/working/sac_q1_{epoch}_HER_dense_rewards.pt'
    save_filename3 = f'/kaggle/working/sac_q2_{epoch}_HER_dense_rewards.pt'
    ...
    print(f"Model saved after {epoch} epoche")
