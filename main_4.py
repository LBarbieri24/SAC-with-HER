...
from SAC_4 import SACAgent,ReplayBufferHER
...
for epoch in range(epochs):
    ...
    for cycle in range(cycles):
        ...
        agent.replay_buffer.add_episode(episode_transitions)
        agent.update()
    ...
    # if episode % 300 == 0:
    save_filename1 = f'sac_policy_{epoch}_HER_leggero.pt'
    save_filename2 = f'sac_q1_{epoch}_HER_leggero.pt'
    save_filename3 = f'sac_q2_{epoch}_HER_leggero.pt'
